...
def set_problem_parameters(default_variables, **namespace):
    ...
    E_s_val = 0.1E6  # Young modulus (Pa)
    nu_s_val = 0.45
    ...
    default_variables.update(dict(
        ...
        Jm=0.5,         # Gent material model constant
        material_model="Gent",
        ...
        folder="Uniaxial_Tension_Gent",          # Folder to store the results
        fluid="no_fluid",                 # Do not solve for the fluid
        extrapolation="no_extrapolation",  # No displacement to extrapolate
        solid_vel=0.2, # this is the velocity of the wall with prescribed displacement
